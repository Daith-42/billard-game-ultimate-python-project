...
while quitter:                   # Si finie entraîne l'arrêt complet du programme ; état de fin : False
    ...
    while regles:
        ...
        afficher_texte("- Jouez chacun votre tour en tirant la boule blanche.                                                                    ", police_casino2, blanc, fenetre, LARGEUR/2, HAUTEUR/2 - 140)
        afficher_texte("- Aidez vous du curseur et régler l'intensité du tire.                                                                       ", police_casino2, blanc, fenetre, LARGEUR/2, HAUTEUR/2 - 100)
        ...
        afficher_texte("- Ne rentrez pas la boule Noir tant que vous n'avez pas rentrez tous les boules de votre", police_casino2, blanc, fenetre, LARGEUR/2, HAUTEUR/2 - 20)
        afficher_texte("couleur !                                                                                                                                                        ", police_casino2, blanc, fenetre, LARGEUR/2, HAUTEUR/2 + 20)
        afficher_texte("- Vous avez un second tour si vous rentrez une boule de votre couleur                                     ", police_casino2, blanc, fenetre, LARGEUR/2, HAUTEUR/2 + 60)
